...
import { Github, Linkedin, Mail, Code,Instagram } from 'lucide-react';
    ...
    return (
        <>
            <div className="min-h-screen text-white overflow-hidden relative p-4">
                ...
                {/* 🔥 Navigation */}
                <nav className="relative z-20 flex items-center justify-between px-8 py-4 shadow-2xl border-amber-50">
                    <div className="flex items-center space-x-2">
                        <div className="w-8 h-8 flex items-center justify-center">
                            <Code size={20}
                                className='w-8 h-8 text-3xl font-extrabold'
                            />
                        </div>
                        <span className="font-semibold text-lg">Mohammed Sadik | Developer</span>
                    </div>
                ...
                {/* 🔥 Main Content */}
                <div className="relative z-20 flex items-center justify-between px-8 mt-20 max-w-7xl mx-auto">
                    <div className="max-w-2xl">
                        ...
                        <button className="group relative px-8 py-4 rounded-full border border-purple-500/50 hover:border-purple-500 transition-all duration-300 overflow-hidden">

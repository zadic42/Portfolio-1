          ...
          <div className="w-full max-w-6xl mx-auto">
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center gap-3 mb-3">
                <div className="w-9 h-9 border-2 border-purple-500 rounded-lg" />
                <span className="text-sm sm:text-base text-purple-400 tracking-wider">
                  Get to know me
                </span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
              ...
              <div className="md:col-span-1 flex flex-col items-center md:items-start text-center md:text-left space-y-4">
                ...
                <p className="text-xs sm:text-sm text-gray-500 max-w-[18rem]">
                  MERN Stack • Next.js • API Integrations • UI/UX Focused
                </p>
              ...
              <div className="md:col-span-2">
                <p className="text-sm sm:text-base md:text-lg text-gray-300 leading-relaxed max-w-3xl">
                  I'm a Full Stack Developer passionate about building beautiful, high-performance
                  web applications with React, Next.js, and Node.js. I focus on smooth user
                  experiences, scalable backend systems, and pixel-perfect UIs. Experienced with
                  REST APIs, GraphQL, Firebase, and modern MERN tooling — always learning and
                  building.
                </p>
                ...
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white/3 p-5 rounded-2xl border border-white/6">
                    ...
                    <div className="space-y-4">
                      <div className="pl-4 relative">
                        <span className="absolute left-0 top-1 w-2 h-2 rounded-full bg-purple-400" />
                        <p className="font-semibold text-purple-300">B.E. Computer Science & Engg</p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center mt-8">
                  <a
                    href="#projects"
                    className="group relative inline-flex items-center justify-center px-6 py-3 rounded-full border-2 border-purple-500 hover:bg-purple-500/10 transition-all duration-300 text-sm sm:text-base font-medium"
                  ...
                  <a
                    ...
                    download
                    className="group relative inline-flex items-center justify-center px-6 py-3 rounded-full border-2 border-gray-500 hover:bg-gray-500/10 transition-all duration-300 text-sm sm:text-base font-medium"
